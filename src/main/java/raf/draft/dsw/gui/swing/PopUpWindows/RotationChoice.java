...
public class RotationChoice {
    public static String showOptionsDialog() {
        ...
        // Style label
        JLabel label = new JLabel("Select rotation option:");
        label.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        label.setForeground(new Color(0x2D2D2D));
        panel.add(label, BorderLayout.NORTH);

        // Style combo box
        String[] options = {"Leva rotacija", "Desna rotacija"};
        ...
        JDialog dialog = optionPane.createDialog(null, "Izaberite rotaciju elemenata");
